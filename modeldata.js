...
var p1 = new ParticleSet("p1", new Material({diffuseColor: [1, 1, 1, 1], drawMode: DrawMode.POINT_TEXTURED, texture:"grass.png"}), new Transform({translate: [0, 5, 0]}), new Transform(), null);
lights = [lightbulb];
particlesets = [p1];