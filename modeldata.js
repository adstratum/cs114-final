var root = new Node(
    ...
    nullAnim,
    undefined);
var ground = new Model("ground", uvCylinder(), new Material([0, .5, 0, 1]), new Transform({rotateDeg: -90, rotateAxis: [1, 0, 0], scale: [15, 15, 1]}), nullAnim, root);
var road = new Model("road", ring(.6, 1), new Material([.5, .5, .5, 1]), new Transform({translate: [0, 0, .51], scale: [6, 6, 1]}), 
