...
var road = new Model("road", ring(.6, 1), new Material({diffuseColor:[.5, .5, .5, 1],  drawMode:DrawMode.PHONG, texture:"f-texture.png"}), new Transform({translate: [0, 0, .51], scale: [6, 6, 1]}), 
